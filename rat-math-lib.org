...
- ratFixSign “rat fix sign” ::
  ...
  #+begin_src forth :tangle rat-math-lib.fs
    : ratFixSign ( num den -- nNum denen ) \ rational “Rational Fix Sign”
	\ Ensure that the denominator is not negative when the numerator is non-zero.
	dup 0<  \ denom < 0 ?
	if over  \ numer <> 0 ?
  ...
  #+begin_src forth :tangle rat-math-lib-tests.fs
    ...
    RatNegMax ratFixSign .s -2147483648 1 d= confirm
    -2147483647 -1 ratFixSign .s RatPosMax d= confirm
    2147483648 -1 ratFixSign .s RatNegMax d= confirm
...
- rat>n ::
  ...
  #+begin_src forth :tangle rat-math-lib-tests.fs
    ...
    ratNegMax rat>n .s -2147483648 = confirm
...
- rat>f ::
  ...
  #+begin_src forth :tangle rat-math-lib-tests.fs
    ...
    ratNegMax rat>f .s ." F: " f.s -2147483648.E0 f= confirm
...
- e8f23>rat ::
  ...
  #+begin_src forth :tangle rat-math-lib.fs
	...
	\ Returns NaN (0/0) if out of rational range.
	f23 $00800000 or  \ base 24-bit numerator
	dup CTZ  \ trailing zeros is 0 to 23
	$00800000  \ base 24-bit denominator
