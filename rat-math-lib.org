...
- rat+ “rat plus” ::
  ...
  #+begin_src forth :tangle rat-math-lib.fs
	...
	ratComDen { numA denA numB denB } \ make denominators common
	numA numB + denA ;  \ Add numerators and use either denominator
  #+end_src
...
- rat1+ “rat one plus” :: 
  ...
  #+begin_src forth :tangle rat-math-lib.fs
    : rat1+ ( num1 den1 -- num2 den2 ) \ add one to a ratio
...
- rat1- “rat 1 minus” :: 
  ...
  #+begin_src forth :tangle rat-math-lib.fs
    : rat1- ( num1 den1 -- num2 den2 )  \ subtract 1 from a ration
